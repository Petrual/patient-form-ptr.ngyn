/*
    ...
    Date Updated: 4/30/2025 2:30 PM
    Version: 4.1
    Purpose: MIS 3371 Web Development Project HW 4 ... Patient Registration Form 😊
    */
...
function validateInput() {
    ...
    if (!validateConPword()) { // Ensure confirmation password is validated
        errorMessages.push("Password confirmation is invalid.");
        valid = false;
    }
...
// window scroll function for header
...
// cookies for remembering user input in the form //
...
// Set cookie for each input field
...
// List of input fields to prefill and set cookies for
